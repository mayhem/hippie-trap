...
typedef uint8_t (*f_method)(void *self, uint32_t t, color_t *src, color_t *dest);
...
uint8_t f_fade_in_get(void *self, uint32_t t, color_t *src, color_t *dest);
...
uint8_t f_fade_out_get(void *self, uint32_t t, color_t *src, color_t *dest);
...
uint8_t f_brightness_get(void *self, uint32_t t, color_t *src, color_t *dest);
...
uint8_t f_color_shift_get(void *self, uint32_t t, color_t *src, color_t *dest);
